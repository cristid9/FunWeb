...
var mainState = {
    ...
    create: function create() {
        ...
        this.questioner1 = this.game.add.sprite(700, 700, 'backendQuestioner');
        this.questioner1BitmapText = this.game.add.text(690, 710, 'Intrebari de\n front-end?', {
            font: "12px Arial",
            fill: "#fff",
        });
    ...
    update: function update() {
        ...
        function collisionHandler(player, questionare) {
            ...
            this.questionerDialogPanel.x = 620;
            this.questionerDialogPanel.y = 680;
            this.questionerDialogPanel.visible = true;

            this.acceptButton.x = 640;
            this.acceptButton.y = 610;
            this.acceptButton.visible = true;

            this.dismissButton.x = 680;
            this.dismissButton.y = 610;
